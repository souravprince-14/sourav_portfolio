    ...
    <footer className="bg-slate-900 border-t border-slate-800">
      <Section id="contact" title="contact_me" className="py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          {/* Contact Form */}
          <form className="bg-slate-950 p-6 md:p-8 rounded-2xl border border-slate-800 space-y-4" onSubmit={handleSendMessage}>
            <div>
            ...
            <button type="submit" className="w-full py-3 bg-gradient-to-r from-python-blue to-sky-600 text-white font-bold rounded-lg hover:opacity-90 transition-opacity flex justify-center items-center gap-2">
